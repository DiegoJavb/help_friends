            ...
            <Grid container style={{minHeight:'100vh'}}>
                ...
                <Grid container item xs={12} sm={6} 
                    ...
                    <div style={{display:'flex', flexDirection:'column', maxWidth:200, minWidth:400}}>
                        ...
                        <div style={{display:'flex',maxWidth:300, minWidth:200, justifyContent:'space-between'}}>
                            <TextField 
                            label='Nombre' 
                            margin='normal'    
                            />
                        ...
                        <TextField 
                            ...
                            margin='normal' 
                            />
                        <div style={{display:'flex',justifyContent:'space-between', maxWidth:300, minWidth:200}}>
                            <TextField 
                            label='Ciudad' 
                            margin='normal'    
                            />
